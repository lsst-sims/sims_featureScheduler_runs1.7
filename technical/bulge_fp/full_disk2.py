...
from lsst.sims.featureScheduler.utils import standard_goals, generate_goal_map, Footprint, ra_dec_hp_map, magellanic_clouds_healpixels
...
if __name__ == "__main__":
    ...
    if scale_down:
        ...
        footprints_hp = full_disk_fp(nside=nside)
