...
class Zero_telrot_detailer(detailers.Base_detailer):
    """
...
def generate_blobs(nside, nexp=2, exptime=30., filter1s=['u', 'u', 'g', 'r', 'i', 'z', 'y'],
    ...
    for filtername, filtername2 in zip(filter1s, filter2s):
        detailer_list = []
        detailer_list.append(Zero_telrot_detailer())
...
if __name__ == "__main__":
    ...
    details = [Zero_telrot_detailer(), dither_detailer]
    euclid_detailers = [Zero_telrot_detailer(),
