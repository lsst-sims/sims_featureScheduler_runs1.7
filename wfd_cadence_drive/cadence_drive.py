...
def generate_blobs(nside, nexp=2, exptime=30., filter1s=['u', 'u', 'g', 'r', 'i', 'z', 'y'],
    ...
    for filtername, filtername2 in zip(filter1s, filter2s):
        ...
        if cadence_weight is None:
            ...
            surveys.append(Plan_ahead_survey(basis_functions, weights, filtername1=filtername, filtername2=filtername2,
                                             exptime=exptime,
                                             ideal_pair_time=pair_time,
...
if __name__ == "__main__":
    ...
    wfd_footprint = footprints_hp['r']
    wfd_footprint[np.where(wfd_footprint != 1.)] = 0
